			...
			default:
				...
				if (Z_TYPE_P(op1) == IS_OBJECT) {
					if (Z_OBJ_HT_P(op1)->get) {
						...
						ret = compare_function_ex(result, op_free, op2, 1);
						...
						ret = compare_function_ex(result, &tmp_free, op2, 1);
						zend_free_obj_get_result(&tmp_free);
						return ret;
					}
				}
				if (Z_TYPE_P(op2) == IS_OBJECT) {
					if (Z_OBJ_HT_P(op2)->get) {
						...
						ret = compare_function_ex(result, op1, op_free, 1);
						zend_free_obj_get_result(op_free);
						return ret;
						...
						ret = compare_function_ex(result, op1, &tmp_free, 1);
						zend_free_obj_get_result(&tmp_free);
						return ret;
